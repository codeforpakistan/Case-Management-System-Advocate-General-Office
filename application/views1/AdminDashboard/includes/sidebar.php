...
<li>
<a class="active-page" href="<?php echo base_url(); ?>AdminDashboard/list_case_category">List case Category</a>
</li>
...
<li>
<a class="active" href="<?php echo base_url(); ?>ITStaffDashboard"><div class="pull-left"><i class="zmdi zmdi-flag mr-20"></i><span class="right-nav-text">Home</span></div><div class="clearfix"></div></a>
</li>


<li>
<a href="<?php echo base_url(); ?>ITStaffDashboard/search"><div class="pull-left"><i class="zmdi zmdi-search data-right-rep-icon mr-20"></i><span class="right-nav-text">Search</span></div><div class="clearfix"></div></a>
...
<ul id="cases" class="collapse collapse-level-1">
<li>
<a class="active-page" href="<?php echo base_url(); ?>ITStaffDashboard/add_case">Add Case</a>
</li>
<li>
<a class="active-page" href="<?php echo base_url(); ?>ITStaffDashboard/list_case">List Case</a>
</li>
...
<li>
<a class="active-page" href="<?php echo base_url(); ?>ITStaffDashboard/link_case">Link Case</a>
</li>
