<!-- Footer -->
<footer class="footer container-fluid pl- pr-30" style="position:relevant;">
<div class="row">
<div class="col-md-4">
<p>2021 &copy; Advocate General. Developed by KPITB.</p>
</div>
</div>
</footer>
<!-- /Footer -->
...
<script src="<?php echo base_url();?>public/vendors/bower_components/moment/min/moment.min.js"></script>
<script src="<?php echo base_url();?>public/vendors/bower_components/simpleWeather/jquery.simpleWeather.min.js"></script>
<script src="<?php echo base_url();?>public/dist/js/simpleweather-data.js"></script>
...
<!-- Owl JavaScript -->
<script src="<?php echo base_url();?>public/vendors/bower_components/owl.carousel/dist/owl.carousel.min.js"></script>
...
<script src="<?php echo base_url();?>public/vendors/bower_components/switchery/dist/switchery.min.js"></script>

<script src="<?php echo base_url();?>public/dist/js/form-advance-data.js"></script>

<!-- Switchery JavaScript -->
<script src="<?php echo base_url();?>public/vendors/bower_components/select2/dist/js/select2.full.min.js"></script> <!-- For Select 2 -->
<!-- Init JavaScript -->
<script src="<?php echo base_url();?>public/dist/js/dashboard-data.js"></script>


<script src="<?php echo base_url();?>public/vendors/bower_components/multiselect/js/jquery.multi-select.js"></script>
