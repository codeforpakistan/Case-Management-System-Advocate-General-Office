                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <p class="" style="line-height:16px;margin-top:10px; font-weight:bold;">
                                                                                                <?php
                                                                                                $branch_id = $case_info[0]->branch_id;
                                                                                    ...
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <select required class="form-control" name="docsname">
                                                                                                ...
                                                                                                <?php
                                                                                                foreach ($getDocsTypes as $docsinfo) {
                                                                                                ?>
                                                                                                    <option value="<?= $docsinfo->title; ?>"><?= $docsinfo->title; ?></option>
                                                                                                <?php
                                                                                                }
                                                                                                ?>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-12">
                                                                                    <div class="form-group ">
                                                                                        ...
                                                                                        <div class="col-md-6">
                                                                                            <input type="file" required="required" name="docs_file" accept=".gif,.jpg,.jpeg,.png,.doc,.docx,.pdf" class="form-control" placeholder="">
