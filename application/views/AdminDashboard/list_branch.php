                            ...
                            <div class="table-wrap">
                                <div class="table-responsive">
                                    <table id="example" class="table table-hover display  pb-30">
                                        ...
                                        <tbody>
                                            <?php $counter = 1;
                                            foreach ($list_branch as $branchinfo) { ?>
                                                <tr>
                                                    <td><?= $counter; ?></td>
                                                    <td><?= $branchinfo->title; ?></td>
                                                    <td><?= $branchinfo->description; ?></td>
                                                    <td class="text-navy">
                                                        <a href='<?php echo base_url(); ?>AdminDashboard/edit_branch/<?= $branchinfo->id; ?>'>
                                                        ...
                                                        <a onclick="return confirm('Sure to Delete...?')" href="<?php echo base_url(); ?>AdminDashboard/deletebranches/<?= $branchinfo->id; ?>">
                                                            <i class=" btn btn-danger btn-anim  btn-xs fa fa-trash"></i>
                                                    </td>
