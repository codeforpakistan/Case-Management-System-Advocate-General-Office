                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="date" class="form-control" value="<?php foreach ($gethearing_docs as $hearing_info) {
                                                                                                                    echo $hearing_info->hearing_date;
                                                                                                                } ?>" name="hearing_date">
                                                                <!-- <span class="help-block"> This is inline help </span>  -->
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="date" class="form-control" value="<?php foreach ($gethearing_docs as $hearing_info) {
                                                                                                                    echo $hearing_info->next_hearing_date;
                                                            ...
                                                            <div class="col-md-6">
                                                                <select class="form-control select2 select2-multiple" name="lawOfficers[]" multiple="multiple">
                                                                    ...
                                                                    <?php foreach ($Lawofficers as $officer_info) { ?>
                                                                        <option <?php foreach ($hearing_lawofficer as $lawofficer_info) {
                                                                                    if ($lawofficer_info->law_officer_id == $officer_info->id) {
                                                                                        echo "selected";
                                                                                    }
                                                                                } ?> value="<?= $officer_info->id; ?>"><?= $officer_info->name; ?></option>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" name="remarks" value="<?php foreach ($gethearing_docs as $hearing_info) {
                                                                                                                                    echo $hearing_info->remarks;
                                                                                                                                } ?>" placeholder="">
                                                                <!-- <span class="help-block"> This is inline help </span>  -->
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="file" class="form-control" value="<?php foreach ($gethearing_docs as $hearing_info) {
                                                                                                                    echo $hearing_info->docs_filename;
                                                                                                                } ?>" placeholder="" accept="doc|docx|jpeg|jpg|png|pdf" name="docs_file">
                                                                <!-- <span class="help-block"> This is inline help </span>  -->
                                                            </div>
                                                        </div>
                                                    </div>
