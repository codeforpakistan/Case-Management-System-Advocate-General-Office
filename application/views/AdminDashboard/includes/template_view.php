...
<a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown">Welcome <strong>
<?php echo $this->session->userdata('name');?></strong> - 
<?php foreach($role_name as $role){ echo $role->name;}?> &nbsp;&nbsp;</span><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div></a>
