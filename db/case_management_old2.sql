...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Feb 16, 2022 at 06:37 AM
...
(30, 'sds', 'Government', '', '8989', 'amir khan', 0, 2, 1, 'nazim khan', 'Rehan ', 'Aitzaz khan', 4, '2022-02-15', 2022, 'No', 1, 0, 0, '2022-02-15', 16, '3');
...
ALTER TABLE `manage_cases`
  ADD CONSTRAINT `manage_cases_ibfk_1` FOREIGN KEY (`case_cateid`) REFERENCES `case_categories` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;
